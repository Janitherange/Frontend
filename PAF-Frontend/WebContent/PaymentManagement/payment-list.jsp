                		...
                		<div class="row mb-4 px-3">
                			<h1 class="mb-5 mr-4 mt-2 left" style="margin-left: -24px;">Payment Management</h1>
								<div class="row mb-3 px-3"> 
                    				<button type="button" class="btn btn-blue text-center" onClick="location.href ='/PAF-Frontend/PaymentManagement/payment-add.jsp'">Add Payment Method</button> 
                    			</div>
<%
								//Delete item----------------------------------
								if (request.getParameter("paymentID") != null)
								{
									...
									Obj2.deletePayment(request.getParameter("PaymentID"));
								}
%>
<%                 				Payment Obj1 = new Payment();
 								out.print(Obj1.readPayments());
%>
