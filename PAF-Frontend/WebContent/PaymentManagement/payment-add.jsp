            	...
            	<div class="col-lg-10">
                	<div class="card2 card border-0 px-4 py-5">
                		<div class="row mb-4 px-3">
                			<h1 class="mb-5 mr-4 mt-2 left" style="margin-left: -24px;">Add New Payment Method</h1>
								...
								<form class="row g-3 needs-validation" action="<%= request.getContextPath() %>/PaymentAddApi" method="post" novalidate >
									<div class="col-md-12">
											<div class="row px-3"> 
                							<label class="mb-1 ">
