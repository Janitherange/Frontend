            		...
            		<div class="col-lg-9">
                		<div class="card2 card border-0 px-4 ">
                			<form class="row g-3 needs-validation" action="<%= request.getContextPath() %>/registerSeller" method="post" novalidate>
                    			...
                    			<div class="row mb-4 px-3"> <small class="font-weight-bold">Already have an account? <a class="text-danger " href ='/PAF-Frontend/UserManagemnt/Seller/seller-sign-in.jsp'>Login</a></small> </div>
