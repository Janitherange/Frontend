                		...
                		<div class="card2 card border-0 px-4 py-10">
                    		...
                    		<div class="row mb-4 px-3">
                    			<div class="twitter text-center mr-3">
                            		<button type="submit" class="btn btn-blue " onclick="location.href ='/PAF-Frontend/OrderManagement/order-list.jsp'">Order Management</button>
                        		</div>
                    		</div>
                    		<div class="row mb-4 px-3">
                    			<div class="facebook text-center mr-3 ml-3">
                            		<button type="submit" class="btn btn-blue " onclick="location.href ='/PAF-Frontend/PaymentManagement/payment-list.jsp'">Payment Management</button>
                        		</div>
                    		</div>
                  		</div>
                	</div>
